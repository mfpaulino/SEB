<!-- Incio modalAlertaCorreio -->
<div class="modal modal-<?php echo $botao;?> fade" id="modalAlertaCorreio"  data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
