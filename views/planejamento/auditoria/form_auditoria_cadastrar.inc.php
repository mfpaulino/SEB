<div class="modal fade modal-wide peq" data-backdrop="static" id="modalCadastrarAuditoria" tabindex="-1" role="dialog" aria-labelledby="modalCadastrarAuditoriaLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header fundo">
				<!--<button type="button" class="close" data-dismiss="modal">&times;</button>-->
				<h4 class="modal-title" id="modalCadastrarAuditoria">Cadastrar Auditoria</h4>
			</div>
			<div class="modal-body">
				<form name="form_auditoria" id="form_auditoria_cadastrar">
					<div class="col-sm-12">
						<div class="row">
							<!-- Select input-->
							<div class="col-sm-2">
