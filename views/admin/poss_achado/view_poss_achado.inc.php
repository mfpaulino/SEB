<div class="box box-solid bg-teal collapsed-box">
	<div class="box-header">
		...
		<h3 class="box-title">Possíveis Achados</h3>
		<div class="pull-right box-tools">
			<div class="btn-group">
				...
				<ul class="dropdown-menu pull-right" role="menu">
					<li><a href="#" data-toggle="modal" data-target="#modalCadastrarPossAchado">Cadastrar Possível Achado</a></li>
					<li class="divider"></li>
					<li><a href="#" data-toggle="modal" data-target="#modalExibirPossAchado">Listar/Imprimir</a></li>
				</ul>
			</div>
	...
	<div class="box-footer text-black" style="border:1px solid black;">
		<div class="row">
			<div class="col-sm-12">
				<form class="form-horizontal" method="POST" action="controllers/admin/poss_achado/poss_achado_alterar.php">
					<div class="box-body">
						<?php include('listas/admin/select_poss_achado.inc.php');?>
					</div>
					<div class="box-footer pull-right">
						<!--botao Alterar poss achado-->
						<button id="btnAlteraPossAchado" type="button" class="btn btn-xs btn-warning"
							data-tooltip="tooltip" title=""
							data-toggle="modal"
							data-target="#modalAlterarPossAchado">
							<i class="fa fa-pencil"></i> Alterar
						</button>
						<!--botao Excluir poss achado-->
						<button id="btnExcluiPossAchado" type="submit" class="btn btn-xs btn-danger" data-toggle="confirmation"
							data-placement="left"
						...
						<button id="btnPossAchadoVinculaQuestao" type="button" class="btn btn-xs btn-primary"
