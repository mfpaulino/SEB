<div class="box box-solid bg-blue collapsed-box">
	<div class="box-header">
		<i class="fa fa-usd"></i>
		<h3 class="box-title">Valores de Diárias</h3>
		<div class="pull-right box-tools">
			<div class="btn-group">
				...
				<ul class="dropdown-menu pull-right" role="menu">
					...
					<li class="divider"></li>
					<li><a href="#" data-toggle="modal" data-target="#modalExibirDiaria">Listar/Imprimir</a></li>
				</ul>
			</div>
	...
	<div class="box-footer text-black" style="border:1px solid black;">
		<div class="row">
			<div class="col-sm-12">
				<form class="form-horizontal" method="POST" action="controllers/admin/diaria/diaria_alterar.php">
					<div class="box-body">
