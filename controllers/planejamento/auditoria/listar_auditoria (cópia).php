...
$sql = "SELECT plan_auditoria.*, id_tipo_evento, icfex FROM plan_auditoria, adm_tipo_evento, cciex_om WHERE cciex_om.codom like unidades AND tipo = tipo_evento ORDER BY ano DESC, id_auditoria DESC";
/** fim teste **/
