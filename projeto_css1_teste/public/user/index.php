...
<head>
  ...
  <link rel="stylesheet" href="<?php echo HOME;?>/componentes/externos/bower_components/bootstrap/dist/css/bootstrap.min.css">
  <link rel="stylesheet" href="<?php echo HOME;?>/componentes/externos/bower_components/font-awesome/css/font-awesome.min.css">
  <link rel="stylesheet" href="<?php echo HOME;?>/componentes/externos/bower_components/Ionicons/css/ionicons.min.css">
  <link rel="stylesheet" href="<?php echo HOME;?>/componentes/externos/dist/css/AdminLTE.css">
  <link rel="stylesheet" href="<?php echo HOME;?>/componentes/externos/dist/css/skins/skin-green.css">
  <link rel="stylesheet" href="<?php echo HOME;?>/componentes/internos/css/siaudi.css">
</head>
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<?php echo HOME;?>componentes/externos/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo HOME;?>componentes/externos/dist/img/cap_paulino.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
					<?php $flag = md5("logout");?>
                  <a href="<?php echo HOME;?>controllers/autenticacao/logout.php?flag=<?php echo $flag;?>" class="btn btn-danger btn-flat">Sair</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
		...
		<?php include_once(PATH.'/views/usuario/form_senha_alterar.inc.php');?>
		<!--inicio modalAlerta -->
		<?php include_once(PATH.'/views/usuario/view_usuario_alertas.inc.php');?>
					...
					<div class="modal-body">
						<form name="form_altera_om" id="form_altera_om" method="POST" action="controllers/usuario/usuario_alterar.php" enctype="multipart/form-data" >
							<div class="form-group">
								...
								<?php include(PATH.'/listas/select_unid_ci.inc.php');?>
							</div>
							<div class="form-group">
  ...
  <?php include_once(PATH . '/componentes/internos/php/rodape.inc.php');?>
  <!-- /.control-sidebar -->
...
<!-- jQuery 3 -->
<script src="<?php echo HOME;?>/componentes/externos/bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="<?php echo HOME;?>/componentes/externos/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
	<script src="<?php echo HOME;?>/componentes/externos/bower_components/bootstrap/dist/js/bootstrapValidator.min.js"></script>
	<script src="<?php echo HOME;?>/componentes/externos/bower_components/bootstrap-confirmation/bootstrap-confirmation.min.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo HOME;?>/componentes/externos/dist/js/adminlte.min.js"></script>
<script src="<?php echo HOME;?>/controllers/usuario/senha_alterar.js"></script>
