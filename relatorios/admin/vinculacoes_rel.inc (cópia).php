		...
		for($h = 0; $h < $con_area->num_rows; $h++){
			...
			<div class="box box-solid bg-default collapsed-box col-sm-12">';
				if($row_area[2] <> ""){//possui subareas vinculadas?
					echo '<br /><button type="button" class="btn btn-xs btn-default" data-toggle="collapse" data-target="#div_areas'.$row_area[0].'"><i class="fa fa-plus"></i></button>'."&nbsp;<b>Área:</b>  ".$row_area[1]. "<br />";
				}
				else{
				...
				<div id="div_areas'.$row_area[0].'" class="collapse col-sm-11">';
					...
					for($i = 0; $i < $qtde_subarea; $i++){
						...
						if($row_subarea[2] <> ""){
							echo "<br />".'<button type="button" class="btn btn-xs btn-default" data-toggle="collapse" data-target="#div_subareas'.$row_area[0].$row_subarea[0].'"><i class="fa fa-plus"></i></button>'."&nbsp;<b>Subárea:</b> ".$row_subarea[1]. "<br />";
						}
						else {
						...
						<div id="div_subareas'.$row_area[0].$row_subarea[0].'" class="collapse text-justify col-sm-11">';
							...
							for($j = 0; $j < $qtde_questao; $j++){
								...
								if($row_questao[2] <> ""){
									echo "<br />".'<button type="button" class="btn btn-xs btn-default" data-toggle="collapse" data-target="#div_questoes'.$row_area[0].$row_subarea[0].$row_questao[0].'"><i class="fa fa-plus"></i></button>'."&nbsp;<b>Questão:</b> ".$row_questao[1]. "<br />";
								}
								else{
								...
								<div id="div_questoes'.$row_area[0].$row_subarea[0].$row_questao[0].'" class="collapse col-sm-11">';
									...
									for($k = 0; $k < $qtde_info_req; $k++){
										...
										if($row_info_req[2] <> ""){
											echo "<br />".'<button type="button" class="btn btn-xs btn-default" data-toggle="collapse" data-target="#div_info_req'.$row_area[0].$row_subarea[0].$row_questao[0].$row_info_req[0].'"><i class="fa fa-plus"></i></button>'."&nbsp;<b>Informação Requerida:</b> ".$row_info_req[1]. "<br />";
										}
										else{
										...
										<div id="div_info_req'.$row_area[0].$row_subarea[0].$row_questao[0].$row_info_req[0].'" class="collapse col-sm-11">';
											...
											echo "<br />".'<button type="button" class="btn btn-xs btn-default" data-toggle="collapse" data-target="#div_fonte_info'.$row_area[0].$row_subarea[0].$row_questao[0].$row_info_req[0].'"><i class="fa fa-plus"></i></button>'."&nbsp;<b>Fontes de Informação</b> <br />";
									...
									if($qtde_proc_coleta > 0){
											echo "<br />".'<button type="button" class="btn btn-xs btn-default" data-toggle="collapse" data-target="#div_proc_coleta'.$row_area[0].$row_subarea[0].$row_questao[0].'"><i class="fa fa-plus"></i></button>'."&nbsp;<b>Procedimentos de Coleta de Dados</b> <br />";
									}
									...
									if($qtde_proc_ana > 0){
											echo "<br />".'<button type="button" class="btn btn-xs btn-default" data-toggle="collapse" data-target="#div_proc_ana'.$row_area[0].$row_subarea[0].$row_questao[0].'"><i class="fa fa-plus"></i></button>'."&nbsp;<b>Procedimentos de Análise de Dados</b> <br />";
									}
									...
									if($qtde_poss_achado > 0){
											echo "<br />".'<button type="button" class="btn btn-xs btn-default" data-toggle="collapse" data-target="#div_poss_achado'.$row_area[0].$row_subarea[0].$row_questao[0].'"><i class="fa fa-plus"></i></button>'."&nbsp;<b>Possíveis Achados</b> <br />";
									}
