											...
											<div class="modal-body">
												<form name="form_editar" id="form_editar" method="POST" action="usuario/altera.php" enctype="multipart/form-data">
													...
													<div class="form-group">
														...
														<input name="identidade" id="identidade" type="text" class="form-control" required />
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input name="nome_completo" id="nome_completo" type="text" class="form-control"  />
													</div>
													<div class="form-group">
...
<script src="componentes/externos/bootstrap-validator_/dist/js/bootstrapValidator.js"></script>		<script type="text/javascript">
...
<script>
	$(document).ready(function() {
        ...
        .on('success.form.bv', function(e) {
            ...
            $form.find('.alert').html('Thanks for signing up. Now you can sign in as ' + validator.getFieldElements('identidade').val()).show();
        });
	});
</script>