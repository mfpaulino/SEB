	...
	if ($validar->validate()){
		...
		if ($email <> "" and $email <> $email_usuario){
			...
			if ($con->affected_rows <> 0){
				$_SESSION['alterar_email_erro'] = "ERRO 019: e-mail já foi cadastrado para outro usuário!";
		...
		$_SESSION['alterar_erro_validacao'] = "ERRO 020: dados inconsistentes, preencha novamente o formulário!";
