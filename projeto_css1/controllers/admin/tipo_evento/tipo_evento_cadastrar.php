...
if (isset($_POST['flag']) and isset($_SESSION['cpf'])){
	...
	if ($validar->validate()){
		...
		if($busca_tipo_evento->num_rows > 0){
			...
			$_SESSION['tipo_evento_duplicada'] = "ERRO A-016: Tipo de Auditoria já cadastrado!";
		...
		if($validacao !== false){
			...
			if($resultado){
				...
				$_SESSION['erro_cadastro_tipo_evento'] = "ERRO A-017: cadastro não realizado, tente novamente!<br />Em caso de persistir o erro, entrar em contato com o suporte técnico.";
				$_SESSION['botao'] = "danger";
			}
		...
		$_SESSION['erro_validacao_cadastrar_tipo_evento'] = "ERRO A-018: dados inconsistentes, preencha novamente o formulário!";
		$_SESSION['botao'] = "danger";
