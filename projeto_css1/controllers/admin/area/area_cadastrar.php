<?php
/**************************************************************
* Local/nome do script: admin/area_cadastrar.php
...
if (isset($_POST['flag']) and isset($_SESSION['cpf'])){
	...
	if ($validar->validate()){
		...
		$busca_area = $mysqli->query("SELECT id_area FROM adm_areas WHERE area = '$area'");


		if($busca_area->num_rows > 0){

			$_SESSION['area_duplicada'] = "ERRO 028: Área já cadastrada!";
		...
		if($validacao !== false){
			...
			if($resultado){
				...
				$_SESSION['erro_cadastro_area'] = "ERRO 029: cadastro não realizado, tente novamente!<br />Em caso de persistir o erro, entrar em contato com o suporte técnico.";
				$_SESSION['botao'] = "danger";
			}
		...
		$_SESSION['erro_validacao_cadastrar_area'] = "ERRO 030: dados inconsistentes, preencha novamente o formulário!";
		$_SESSION['botao'] = "danger";
