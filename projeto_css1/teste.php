...
<div class="container">
    <form role="form" method="POST" action="#" name="form_correio_cadastrar" id="form_correio_cadastrar">
        <div class='box-body pad'>
			<div class="form-group">
                    <input type="text" class="form-control" placeholder="Enter text ..." name="destinatario[]" />
            </div>
            <div class="form-group">
                <div class="lnbrd">
...
<script src="componentes/externos/jquery/dist/jquery.min.js"></script>
	...
	<script src="componentes/internos/js/teste.js"></script>
	<!--
<script>
