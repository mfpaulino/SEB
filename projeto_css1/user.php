        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $posto_usuario . " " . $nome_guerra_usuario;?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p><?php echo $perfil_usuario . " - " . $sigla_usuario;?>
                  <small>Usuário desde <?php echo $dt_cad_usuario;?></small>
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        <form method="post">
          ...
          <div class="form-group">
			...
			<br />
            <p>
              O usuário poderá visualizar e/ou alterar as infomrações do seu perfil pessoal clicando nos links acima.
            </p>
          </div>
          <!-- /.form-group -->
        </form>
