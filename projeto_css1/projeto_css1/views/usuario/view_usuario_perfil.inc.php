	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header fundo">
				...
				<h4 class="modal-title" id="modalVisualizarLabel">PERFIL DO USUÁRIO (<?php echo $perfil_usuario;?> - <?php echo $sigla_usuario;?>)</h4>
			</div>
			<div class="modal-body">
				<form>
					...
					<div class="col-sm-8">
						...
						<?php if($user_habilita_usuario <> "  ()"){//oculta, para o caso de o usuário ainda nao ter sido habilitado?>
							<div class="row">
								<!-- Text input-->
								<div class="col-sm-6">
									<div class="form-group">
