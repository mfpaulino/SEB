<div class="box box-solid bg-yellow collapsed-box">
	<div class="box-header">
		...
		<h3 class="box-title">Matriz de Responsabilização</h3>
		<div class="pull-right box-tools">
			<div class="btn-group">
				...
				<ul class="dropdown-menu pull-right" role="menu">
					<li><a href="#" data-toggle="modal" data-target="#modalCadastrarArea">Cadastrar Matriz de Responsabilização</a></li>
					<li class="divider"></li>
