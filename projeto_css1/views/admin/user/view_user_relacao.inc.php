<?php
$sql = "SELECT id_usuario, cpf, rg, nome_guerra, nome, email, ritex, celular, avatar, dt_cad, usuarios.id_posto, p.posto, codom, perfil, perfil_om, ultimo_acesso, acesso_anterior, status from usuarios, postos p where usuarios.id_posto = p.id_posto and cpf <> '$cpf' order by usuarios.id_posto";
